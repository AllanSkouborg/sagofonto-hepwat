...
//ORIGINAL LINE: private byte[] StrToByteArray(string str)
    private byte[] StrToByteArray(String str)
    {
        if (str.length() == 0)
        {
            throw new RuntimeException("Invalid string value in StrToByteArray");
        }
...
//ORIGINAL LINE: byte val;
        byte val;
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: byte[] byteArr = new byte[str.Length / 3];
        ...
        {
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: val = byte.Parse(str.Substring(i, 3));
            val = Byte.parseByte(str.substring(i, i + 3));
            byteArr[j++] = val;
            i += 3;
        } while (i < str.length());
        return byteArr;
    ...
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: private string ByteArrToString(byte[] byteArr)
...
//ORIGINAL LINE: byte val;
        ...
        for (int i = 0; i <= byteArr.length - 1; i++)
        {
            val = byteArr[i];
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: if (val < (byte)10)
            if (val < (byte)10)
            {
                tempStr += "00" + String.valueOf(val);
            }
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: else if (val < (byte)100)
            else if (val < (byte)100)
            {
                tempStr += "0" + String.valueOf(val);
            }
            else
            {
                tempStr += String.valueOf(val);
            }
        }
        return tempStr;
    }
