...
import dk.artogis.hepwat.calculationService.configuration.ServiceConfiguration;
...
public class Calculation {
    ...
    public Calculation(ServiceConfiguration serviceConfiguration, DeviceConfigurationFormulas deviceConfigurationFormulas, Logger instantiatedLogger)
    {
        logger = instantiatedLogger;
        this.serviceConfiguration = serviceConfiguration;
        this.deviceConfigurationFormulas = deviceConfigurationFormulas;
    ...
    //public void run()
    {
        ...
        KStream<String , JsonNode> filteredStream = rawStream.filter((key, value) -> {
            ...
            try {
                ...
                try {
                    ...
                    if ((deviceConfigurationFormulas.HasCalculation(id, calctype)) && (serviceConfiguration.isInConfigurationCalculationTypes(calctype))) {
                        hasCalculation = true;
                    }
                }
                catch (Exception ex)
        ...
        KStream<String, JsonNode> calculatedStream = filteredStream.mapValues( measurement -> Calculate.newValue( measurement, serviceConfiguration.calcType, deviceConfigurationFormulas, nashorn, lock, logger) );
